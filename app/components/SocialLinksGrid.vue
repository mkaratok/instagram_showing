<template>
  <div v-if="activeLinks.length > 0" class="flex flex-wrap justify-center gap-4">
    <a 
      ...
      target="_blank"
      rel="noopener"
      class="social-icon flex items-center justify-center w-11 h-11 rounded-full transition-all duration-300 ease-out"
      :class="isDark 
        ? 'bg-white/10 text-earth-300' 
        : 'bg-gray-100 text-gray-600'"
      :title="platformNames[link.key] || link.key"
    >
      <component :is="getIcon(link.key)" class="w-5 h-5 transition-transform duration-300" />
    </a>
  </div>
</template>
...
const icons: Record<string, any> = {
  ...
  pttavm: () => h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
    h('path', { d: 'M20 6H4l-1 14h18L20 6zM4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zm4 9h8v2H8v-2zm0-3h8v2H8v-2z' })
  ]),
  amazonTr: () => h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
    h('path', { d: 'M.045 18.02c.072-.116.187-.124.348-.022 3.636 2.11 7.594 3.166 11.87 3.166 2.852 0 5.668-.533 8.447-1.595l.315-.14c.138-.06.234-.1.293-.13.226-.088.39-.046.525.13.12.174.09.336-.12.48-.256.19-.6.41-1.006.654-1.244.743-2.64 1.316-4.185 1.726a17.617 17.617 0 01-10.951-.577 17.88 17.88 0 01-5.43-3.57c-.074-.074-.1-.13-.1-.166l-.004-.05z' })
  ]),
  ciceksepeti: () => h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
    h('path', { d: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zm0-3a7 7 0 110-14 7 7 0 010 14z' })
  ]),
...
.social-icon:hover {
  ...
  background: linear-gradient(135deg, #fbbf24, #ec4899, #8b5cf6) !important;
