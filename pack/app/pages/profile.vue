                ...
                <div class="grid md:grid-cols-2 gap-8 items-start">
                  <div class="space-y-4 text-sm font-medium">
                     <div class="flex items-center gap-3">
                       <span class="w-6 text-center">fb</span> <span>facebook</span>
                     </div>
                     <div class="flex items-center gap-3">
                       <span class="w-6 text-center">ig</span> <span>@{{ profile?.username || 'user' }}</span>
                     </div>
                     <div class="flex items-center gap-3">
                       <span class="w-6 text-center">yt</span> <span>youtube</span>
                     </div>
                     <div class="flex items-center gap-3">
                       <span class="w-6 text-center">wp</span> <a :href="profile?.website || '#'" target="_blank">{{ profile?.business_phone_number || 'Contact' }}</a>
                     </div>
                     <div class="flex items-center gap-3">
                     ...
                     <div class="flex items-center gap-3">
                        <span class="w-6 text-center">✉️</span> <a :href="'mailto:' + (profile?.business_email || '')">{{ profile?.business_email || 'Email' }}</a>
                     </div>
                  </div>
          ...
          <footer class="py-8 text-center border-t border-subtle-light dark:border-subtle-dark mt-auto">
            <div class="flex flex-col gap-4">
              ...
              <p class="text-xs text-subtle-light dark:text-subtle-dark opacity-60">
                © {{ new Date().getFullYear() }} {{ profile?.name || profile?.username || 'Portfolio' }}. Tüm hakları saklıdır.
              </p>
            </div>
          </footer>
